    ...
    <section className="mb-16 md:mb-20">
      <div className="mb-6 space-y-2 text-center">
        ...
        <p className="mx-auto max-w-2xl text-sm text-slate-400 md:text-[15px]">
          ...
          entrega e manter o app saudavel no longo prazo.
        </p>
      </div>
      ...
      <div className="space-y-5">
        {items.map((feature, index) => (
          <motion.div
            key={feature.id}
            className="flex flex-col gap-4 rounded-2xl border border-white/10 bg-slate-950/60 p-4 shadow-[0_18px_40px_rgba(15,23,42,0.9)] backdrop-blur-sm md:flex-row md:items-center md:justify-between"
          ...
          >
            ...
            {/* Mini mockup / ilustracao abstrata */}
